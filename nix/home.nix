...
in {
  ...
  programs = {
    ...
    git = {
      ...
      userEmail = "tnixxc@gmail.com"; # FIXME: set your git email
      userName = "Tnixc"; #FIXME: set your git username
      extraConfig = {
    ...
    zsh = {
      ...
      shellAliases = {
        ...
        nixre = "sudo nixos-rebuild switch --flake ~/config/nix";
      ...
      initExtra = ''
        alias conf='sudo lvim ~/config/nix'
        alias a=lvim
        alias vim=lvim
        alias nvim=lvim
        alias ga='git add'
